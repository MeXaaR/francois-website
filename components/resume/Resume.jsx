          ...
          <div className="section-wrapper border-redius-20 bg-light-white-2 mt-20  pt-70 pb-60 pl-30 pr-30">
            <div className="row">
                  ...
                  {skillData.map((elm, i) => (
                    ...
                    >
                      <div className="title-wrap">
                        ...
                        <span className="count">Niveau {elm.progress} - XP {(elm.progress * Math.floor(Math.random() * 10000)).toLocaleString('fr-FR')} </span>
                      </div>
              ...
              <div className="col-xl-6 col-lg-5">
                <div className="bostami-section-title-wrap mb-20">
                  <h4 className="section-title">Connaissances</h4>
                </div>
